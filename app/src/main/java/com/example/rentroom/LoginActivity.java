...
public class LoginActivity extends AppCompatActivity {
    ...
    public void verify(View view) {
        ...
        if(PhoneNumber.length() == 0){
            ...
            TextView mSnackBarTextView = (TextView) snackBarView.findViewById(com.google.android.material.R.id.snackbar_text);
    ...
    public void loginButton(View v){
        ...
        if(PhoneNumber.length() == 0){
            ...
            View snackBarView = snackbar.getView();
            snackBarView.setBackgroundColor(getResources().getColor(R.color.errorSnackBarColor));
            TextView mSnackBarTextView = snackBarView.findViewById(com.google.android.material.R.id.snackbar_text);
            mSnackBarTextView.setTextAlignment(snackBarView.TEXT_ALIGNMENT_CENTER);
            snackbar.show();
        }
        else if(PhoneNumber.length() != 10) {
